package com.zibuyuqing.roundcorner.log;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler{
    ...
    private static final SimpleDateFormat sFormatter = new SimpleDateFormat("yyyyMMddHHmmss");
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String time = sFormatter.format(curDate);
            String fileName = "crash -" + time +".txt";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getPath() + "/" + NotificationListener.ME + "/crash/";
